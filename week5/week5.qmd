...
**RESPONSE**: 1(inside), protected, deforestation decreased; 0(outside), unprotected, deforestation increased
...
**RESPONSE**: NO discontinuity at distance = 0 mean that the policy or treatment being studied has no local causal effect on forest loss.
...
**RESPONSE**: The protected area decreases the deforestation rate in protected areas by 10%. The slope in the protected areas is 2% higher compared to the unprotected areas.
...
**RESPONSE**: We have used a lower bandwidth (-2.207 to +2.207), that means there are lower data, they are close to our cutoff (0), which is threshold.
...
**RESPONSE**: (check discontinuity line)
