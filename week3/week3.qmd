...
**Your answer here.** The lines are not moving together before the lockdown. Around late February, the NO2 increases for LA while NO2 is decreasing for Phoenix, the blue and red lines are moving in opposite directions. This is because DiD assumes both groups would follow similar trends without the treatment. Since they were already diverging before the lockdown, we can't confidently attribute the post-lockdown difference to the policy itself, it might just be a continuation of pre-existing differences.
...
**Your answer here.** Here, the lines are moving closely together. When the NO2 increases in Texas, it is also tends to increase in New Mexico, and vice versa. This is because neighboring regions share similar weather patterns, wind currents and seasonal factors that affect air quality. When two areas experience the same environmental conditions, any differences we see after a policy change are more likely due to the policy itself rather than unrelated local factors.

Distant cities like LA and Phoenix have different weather, traffic, and industries, which makes it harder to tell if changes are caused by the policy or by these other factors.
...
**Answer:** The treatment effect of -3.5 means that after the lockdown in New Mexico, NO2 levels dropped by an additional 3.5 ppb compared to Texas, beyond any changes that were already happening in both states. However, the p-value of 0.22 tells us this effect is not statistically significant. We can't confidently say the lockdown caused this difference rather than random chance.
...
**Answer:** No, the 2020 data alone doesn't tell the whole story. If NO2 naturally drops every year during spring due to seasonal patterns such as warmer weather or less heating, then the decline we're seeing might have happened regardless of the lockdown. To know if the lockdown actually caused the drop, we would need to compare 2020 to previous years and see if the drop was larger or different than usual.
...
**Your answer here.** Yes, Texas makes a compelling counterfactual which satisfies the main causal identification assumption for DiD.

Before the lockdown, both states the NO2 in both states rise and fall together, meaning they follow similar patterns. This is what DiD needs to work properly. Unlike LA and Phoenix, which moved in opposite directions, New Mexico and Texas stay in sync before the policy, so Texas can reasonably show us what New Mexico would have looked like without the lockdown.
...
**Your answer here.** The treatment effect is the treated:is_post coefficient (-3.516). It is not statistically significant at the 5% level because its p-value is 0.22, which is greater than 0.05. This means we can not be confident that the lockdown actually caused the drop in NO2. There is a 22% chance we would see a difference this large just by random chance, even if the lockdown had no real effect.
...
**Your answer here.** Texas serves as our counterfactual. It shows us what New Mexico's NO2 levels might have looked like without the lockdown.

If a massive dust storm hit both El Paso and Dona Ana on March 25th, it would not ruin our DiD estimate, as long as it affects both areas equally. DiD works by comparing the difference between the two groups, so if both experience the same shock, it cancels out. The problem would only arise if the storm hit one area but not the other.
...
**Your answer here.** If people in El Paso stayed home voluntarily just like people in New Mexico, our DiD estimate would get smaller, closer to zero. This is because both groups would have fewer cars on the road, so NO2 would drop in both places. DiD measures the difference between the two groups. If they behave the same way, there's no difference to detect, even if the lockdown actually worked.
