...
**Intercept (77.91): Without any treatment, we expect the umber of treat piles to be \~78 on average.**

**Treat(-24.77): The treatment reduced the average number of trash piles by approximately 25 piles.**
...
**Coefficient: The model estimates that the treatment reduced waste burning be 32% in treated neighborhoods.**
...
**Intercept: On average, there are approximately 74 waste piles in the control group/ untreated neighborhoods.**

**Treat: On average, there was a 35% reduction in waste piles in the treated neighborhoods.**
...
Here, pre_count_average is 0.

**Intercept: On average, (scenario where the pre_count_average is 0), the waste pile for the pre treatment area where pre count average is 0, the waste pile is 1.6.**

**Coefficient: On average, there was ... reduction in waste piles in the control neighborhoods.**
